...
public partial class MainPage : ContentPage
{
	...
	{
		// Nos aseguramos de quien este enviando este evento es un elemento tipo boton
		if(sender is Button)
		{
			// Hacemos la conversion de un tipo de dato button porque por defalt recibe un object
